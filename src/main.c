...
#define MAX_ARTICULOS 50
	...
	void anadirCanasta(); 
	void mostarProductos(int, int); 
	void verCanasta();
	void eliminarCanasta(); 
	void canastaVacia(); 
	void procesarCompra(); 
	void pedirDatosUsuario(char *, char *, char *, char *, char *, int *); 
	void procesarPago();
	void datosTarjeta();
...
int listaArticulos[MAX_ARTICULOS]={0};
    ...
    //funcion utilitaria que añande elementos al carrito
void anadirCanasta()
{
...
void mostarProductos(int incioCategoria, int finCategoria)
{
    ...
    //funcion utilitaria que muestra los elementos y verifica si hay elementos en la misma
void verCanasta()
{
...
void pagoTransferencia()
{
    ...
    printf("\tN�mero de cuenta: 1542 7896 3215 7851\n");
    printf("\tN�mero de sucursal: 4638\n");
...
void pagoOxxo(){
    ...
    printf("\tEsta ficha de pago tiene una vigencia de 3 dias apartir del dia de hoy\n\trecuerda que tus pagos en oxxo los podras realizar de 8am a 8pm todos los dias del a�o");
}
